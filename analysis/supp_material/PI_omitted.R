...
get_coverage_PI_omit = function(par_index_, scale_val_sim_, n_dat){
...
PI_omitted <- foreach(
  ...
  get_coverage_PI_omit(par_index, scale_val_sim, n_dat)
}

parallel::stopCluster(cl = my.cluster)

print(apply(PI_omitted, 2, mean, na.rm = T)) 


saveRDS(PI_omitted, file = paste0("./analysis/supp_material/simulation_output/PI_omitted_",
                                  par_index,"_",
                                  n_dat,
                                  ".rds"))
